...
const ProductDetail = ({ product, onExit }) => {
    // ACA ENTRA LA LOGICA PARA TRAER EL PRODUCTO POR ID
                    ...
                    {product && (
                        <div className="product-detail-content">
                            ...
                            <div className="product-detail-info">
                                ...
                                <button className="btn btn-primary add-to-cart-btn" data-product-id={product.id}>
                                    Añadir al Carrito
                                </button>
                            </div>
